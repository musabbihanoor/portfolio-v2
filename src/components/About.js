...
const About = ({ typing }) => {
  ...
  return (
    <div className="relative z-20 flex items-start justify-center md:p-20 p-10">
      {showContent && (
        <>
          ...
          <AnimatedDiv>
            ...
            <p className="md:w-[550px] w-full text-lg">
              ...
              . I love creating cool stuff that looks great and is easy to use.
              My focus is on making interfaces that are both visually stunning
              and user-friendly. I&apos;ve worked on multiple of projects, from
